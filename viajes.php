...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <p><input type="file" onchange="viajes.readInputFile(this.files);" accept=".xml" ></p>
    
        </section>
        <section>
            <h3>Seleccione un archivo KML: </h3>
          
            <p><input type="file" onchange="viajes.readInputFileKml(this.files);" accept=".kml" multiple></p>
            <section></section>
        ...
        <section>
            ...
            <p><input type="file" onchange="viajes.readInputFileSvg(this.files);" accept=".svg" multiple></p>
            <section></section>
